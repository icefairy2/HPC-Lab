...
void kernel_M128_N128_K128_S8192_knl(const double* A, const double* B, double* C) {
  ...
  __asm__ __volatile__("movq %0, %%rdi\n\t"
                       ...
                       "addq $8, %%r12\n\t"
                       "vmovupd 0(%%rdx), %%zmm6\n\t"
                       "vmovupd 65536(%%rdx), %%zmm7\n\t"
                       "vmovupd 131072(%%rdx), %%zmm8\n\t"
                       "vmovupd 196608(%%rdx), %%zmm9\n\t"
                       "vmovupd 262144(%%rdx), %%zmm10\n\t"
                       "vmovupd 327680(%%rdx), %%zmm11\n\t"
                       "vmovupd 393216(%%rdx), %%zmm12\n\t"
                       "vmovupd 458752(%%rdx), %%zmm13\n\t"
                       "vmovupd 524288(%%rdx), %%zmm14\n\t"
                       "vmovupd 589824(%%rdx), %%zmm15\n\t"
                       "vmovupd 655360(%%rdx), %%zmm16\n\t"
                       "vmovupd 720896(%%rdx), %%zmm17\n\t"
                       "vmovupd 786432(%%rdx), %%zmm18\n\t"
                       "vmovupd 851968(%%rdx), %%zmm19\n\t"
                       "vmovupd 917504(%%rdx), %%zmm20\n\t"
                       "vmovupd 983040(%%rdx), %%zmm21\n\t"
                       "vmovupd 1048576(%%rdx), %%zmm22\n\t"
                       "vmovupd 1114112(%%rdx), %%zmm23\n\t"
                       "vmovupd 1179648(%%rdx), %%zmm24\n\t"
                       "vmovupd 1245184(%%rdx), %%zmm25\n\t"
                       "vmovupd 1310720(%%rdx), %%zmm26\n\t"
                       "vmovupd 1376256(%%rdx), %%zmm27\n\t"
                       "vmovupd 1441792(%%rdx), %%zmm28\n\t"
                       "vmovupd 1507328(%%rdx), %%zmm29\n\t"
                       "vmovupd 1572864(%%rdx), %%zmm30\n\t"
                       "vmovupd 1638400(%%rdx), %%zmm31\n\t"
                       "pushq %%rdx\n\t"
                       "movq $0, %%r14\n\t"
                       "2:\n\t"
                       "addq $8, %%r14\n\t"
                       ...
                       "popq %%rdx\n\t"
                       "vmovupd %%zmm6, 0(%%rdx)\n\t"
                       "vmovupd %%zmm7, 65536(%%rdx)\n\t"
                       "vmovupd %%zmm8, 131072(%%rdx)\n\t"
                       "vmovupd %%zmm9, 196608(%%rdx)\n\t"
                       "vmovupd %%zmm10, 262144(%%rdx)\n\t"
                       "vmovupd %%zmm11, 327680(%%rdx)\n\t"
                       "vmovupd %%zmm12, 393216(%%rdx)\n\t"
                       "vmovupd %%zmm13, 458752(%%rdx)\n\t"
                       "vmovupd %%zmm14, 524288(%%rdx)\n\t"
                       "vmovupd %%zmm15, 589824(%%rdx)\n\t"
                       "vmovupd %%zmm16, 655360(%%rdx)\n\t"
                       "vmovupd %%zmm17, 720896(%%rdx)\n\t"
                       "vmovupd %%zmm18, 786432(%%rdx)\n\t"
                       "vmovupd %%zmm19, 851968(%%rdx)\n\t"
                       "vmovupd %%zmm20, 917504(%%rdx)\n\t"
                       "vmovupd %%zmm21, 983040(%%rdx)\n\t"
                       "vmovupd %%zmm22, 1048576(%%rdx)\n\t"
                       "vmovupd %%zmm23, 1114112(%%rdx)\n\t"
                       "vmovupd %%zmm24, 1179648(%%rdx)\n\t"
                       "vmovupd %%zmm25, 1245184(%%rdx)\n\t"
                       "vmovupd %%zmm26, 1310720(%%rdx)\n\t"
                       "vmovupd %%zmm27, 1376256(%%rdx)\n\t"
                       "vmovupd %%zmm28, 1441792(%%rdx)\n\t"
                       "vmovupd %%zmm29, 1507328(%%rdx)\n\t"
                       "vmovupd %%zmm30, 1572864(%%rdx)\n\t"
                       "vmovupd %%zmm31, 1638400(%%rdx)\n\t"
                       "addq $64, %%rdx\n\t"
                       "subq $131008, %%rdi\n\t"
                       "cmpq $128, %%r12\n\t"
                       "jl 1b\n\t"
                       ...
                       "vmovupd 131072(%%rdx), %%zmm9\n\t"
                       "vmovupd 196608(%%rdx), %%zmm10\n\t"
                       "vmovupd 262144(%%rdx), %%zmm11\n\t"
                       "vmovupd 327680(%%rdx), %%zmm12\n\t"
                       "vmovupd 393216(%%rdx), %%zmm13\n\t"
                       "vmovupd 458752(%%rdx), %%zmm14\n\t"
                       "vmovupd 524288(%%rdx), %%zmm15\n\t"
                       "vmovupd 589824(%%rdx), %%zmm16\n\t"
                       "vmovupd 655360(%%rdx), %%zmm17\n\t"
                       "vmovupd 720896(%%rdx), %%zmm18\n\t"
                       "vmovupd 786432(%%rdx), %%zmm19\n\t"
                       "vmovupd 851968(%%rdx), %%zmm20\n\t"
                       "vmovupd 917504(%%rdx), %%zmm21\n\t"
                       "vmovupd 983040(%%rdx), %%zmm22\n\t"
                       "vmovupd 1048576(%%rdx), %%zmm23\n\t"
                       "vmovupd 1114112(%%rdx), %%zmm24\n\t"
                       "vmovupd 1179648(%%rdx), %%zmm25\n\t"
                       "vmovupd 1245184(%%rdx), %%zmm26\n\t"
                       "vmovupd 1310720(%%rdx), %%zmm27\n\t"
                       "vmovupd 1376256(%%rdx), %%zmm28\n\t"
                       "vmovupd 1441792(%%rdx), %%zmm29\n\t"
                       "vmovupd 1507328(%%rdx), %%zmm30\n\t"
                       "vmovupd 1572864(%%rdx), %%zmm31\n\t"
                       "pushq %%rdx\n\t"
                       "movq $0, %%r14\n\t"
                       "2:\n\t"
                       "addq $8, %%r14\n\t"
                       ...
                       "vmovupd %%zmm9, 131072(%%rdx)\n\t"
                       "vmovupd %%zmm10, 196608(%%rdx)\n\t"
                       "vmovupd %%zmm11, 262144(%%rdx)\n\t"
                       "vmovupd %%zmm12, 327680(%%rdx)\n\t"
                       "vmovupd %%zmm13, 393216(%%rdx)\n\t"
                       "vmovupd %%zmm14, 458752(%%rdx)\n\t"
                       "vmovupd %%zmm15, 524288(%%rdx)\n\t"
                       "vmovupd %%zmm16, 589824(%%rdx)\n\t"
                       "vmovupd %%zmm17, 655360(%%rdx)\n\t"
                       "vmovupd %%zmm18, 720896(%%rdx)\n\t"
                       "vmovupd %%zmm19, 786432(%%rdx)\n\t"
                       "vmovupd %%zmm20, 851968(%%rdx)\n\t"
                       "vmovupd %%zmm21, 917504(%%rdx)\n\t"
                       "vmovupd %%zmm22, 983040(%%rdx)\n\t"
                       "vmovupd %%zmm23, 1048576(%%rdx)\n\t"
                       "vmovupd %%zmm24, 1114112(%%rdx)\n\t"
                       "vmovupd %%zmm25, 1179648(%%rdx)\n\t"
                       "vmovupd %%zmm26, 1245184(%%rdx)\n\t"
                       "vmovupd %%zmm27, 1310720(%%rdx)\n\t"
                       "vmovupd %%zmm28, 1376256(%%rdx)\n\t"
                       "vmovupd %%zmm29, 1441792(%%rdx)\n\t"
                       "vmovupd %%zmm30, 1507328(%%rdx)\n\t"
                       "vmovupd %%zmm31, 1572864(%%rdx)\n\t"
                       "addq $64, %%rdx\n\t"
                       "subq $131008, %%rdi\n\t"
                       "cmpq $128, %%r12\n\t"
                       "jl 1b\n\t"
