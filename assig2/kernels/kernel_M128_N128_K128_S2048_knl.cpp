...
void kernel_M128_N128_K128_S2048_knl(const double* A, const double* B, double* C) {
  ...
  __asm__ __volatile__("movq %0, %%rdi\n\t"
                       ...
                       "addq $8, %%r12\n\t"
                       "vmovupd 0(%%rdx), %%zmm6\n\t"
                       "vmovupd 16384(%%rdx), %%zmm7\n\t"
                       "vmovupd 32768(%%rdx), %%zmm8\n\t"
                       "vmovupd 49152(%%rdx), %%zmm9\n\t"
                       "vmovupd 65536(%%rdx), %%zmm10\n\t"
                       "vmovupd 81920(%%rdx), %%zmm11\n\t"
                       "vmovupd 98304(%%rdx), %%zmm12\n\t"
                       "vmovupd 114688(%%rdx), %%zmm13\n\t"
                       "vmovupd 131072(%%rdx), %%zmm14\n\t"
                       "vmovupd 147456(%%rdx), %%zmm15\n\t"
                       "vmovupd 163840(%%rdx), %%zmm16\n\t"
                       "vmovupd 180224(%%rdx), %%zmm17\n\t"
                       "vmovupd 196608(%%rdx), %%zmm18\n\t"
                       "vmovupd 212992(%%rdx), %%zmm19\n\t"
                       "vmovupd 229376(%%rdx), %%zmm20\n\t"
                       "vmovupd 245760(%%rdx), %%zmm21\n\t"
                       "vmovupd 262144(%%rdx), %%zmm22\n\t"
                       "vmovupd 278528(%%rdx), %%zmm23\n\t"
                       "vmovupd 294912(%%rdx), %%zmm24\n\t"
                       "vmovupd 311296(%%rdx), %%zmm25\n\t"
                       "vmovupd 327680(%%rdx), %%zmm26\n\t"
                       "vmovupd 344064(%%rdx), %%zmm27\n\t"
                       "vmovupd 360448(%%rdx), %%zmm28\n\t"
                       "vmovupd 376832(%%rdx), %%zmm29\n\t"
                       "vmovupd 393216(%%rdx), %%zmm30\n\t"
                       "vmovupd 409600(%%rdx), %%zmm31\n\t"
                       "pushq %%rdx\n\t"
                       "movq $0, %%r14\n\t"
                       "2:\n\t"
                       "addq $8, %%r14\n\t"
                       ...
                       "popq %%rdx\n\t"
                       "vmovupd %%zmm6, 0(%%rdx)\n\t"
                       "vmovupd %%zmm7, 16384(%%rdx)\n\t"
                       "vmovupd %%zmm8, 32768(%%rdx)\n\t"
                       "vmovupd %%zmm9, 49152(%%rdx)\n\t"
                       "vmovupd %%zmm10, 65536(%%rdx)\n\t"
                       "vmovupd %%zmm11, 81920(%%rdx)\n\t"
                       "vmovupd %%zmm12, 98304(%%rdx)\n\t"
                       "vmovupd %%zmm13, 114688(%%rdx)\n\t"
                       "vmovupd %%zmm14, 131072(%%rdx)\n\t"
                       "vmovupd %%zmm15, 147456(%%rdx)\n\t"
                       "vmovupd %%zmm16, 163840(%%rdx)\n\t"
                       "vmovupd %%zmm17, 180224(%%rdx)\n\t"
                       "vmovupd %%zmm18, 196608(%%rdx)\n\t"
                       "vmovupd %%zmm19, 212992(%%rdx)\n\t"
                       "vmovupd %%zmm20, 229376(%%rdx)\n\t"
                       "vmovupd %%zmm21, 245760(%%rdx)\n\t"
                       "vmovupd %%zmm22, 262144(%%rdx)\n\t"
                       "vmovupd %%zmm23, 278528(%%rdx)\n\t"
                       "vmovupd %%zmm24, 294912(%%rdx)\n\t"
                       "vmovupd %%zmm25, 311296(%%rdx)\n\t"
                       "vmovupd %%zmm26, 327680(%%rdx)\n\t"
                       "vmovupd %%zmm27, 344064(%%rdx)\n\t"
                       "vmovupd %%zmm28, 360448(%%rdx)\n\t"
                       "vmovupd %%zmm29, 376832(%%rdx)\n\t"
                       "vmovupd %%zmm30, 393216(%%rdx)\n\t"
                       "vmovupd %%zmm31, 409600(%%rdx)\n\t"
                       "addq $64, %%rdx\n\t"
                       "subq $131008, %%rdi\n\t"
                       "cmpq $128, %%r12\n\t"
                       "jl 1b\n\t"
                       ...
                       "vmovupd 32768(%%rdx), %%zmm9\n\t"
                       "vmovupd 49152(%%rdx), %%zmm10\n\t"
                       "vmovupd 65536(%%rdx), %%zmm11\n\t"
                       "vmovupd 81920(%%rdx), %%zmm12\n\t"
                       "vmovupd 98304(%%rdx), %%zmm13\n\t"
                       "vmovupd 114688(%%rdx), %%zmm14\n\t"
                       "vmovupd 131072(%%rdx), %%zmm15\n\t"
                       "vmovupd 147456(%%rdx), %%zmm16\n\t"
                       "vmovupd 163840(%%rdx), %%zmm17\n\t"
                       "vmovupd 180224(%%rdx), %%zmm18\n\t"
                       "vmovupd 196608(%%rdx), %%zmm19\n\t"
                       "vmovupd 212992(%%rdx), %%zmm20\n\t"
                       "vmovupd 229376(%%rdx), %%zmm21\n\t"
                       "vmovupd 245760(%%rdx), %%zmm22\n\t"
                       "vmovupd 262144(%%rdx), %%zmm23\n\t"
                       "vmovupd 278528(%%rdx), %%zmm24\n\t"
                       "vmovupd 294912(%%rdx), %%zmm25\n\t"
                       "vmovupd 311296(%%rdx), %%zmm26\n\t"
                       "vmovupd 327680(%%rdx), %%zmm27\n\t"
                       "vmovupd 344064(%%rdx), %%zmm28\n\t"
                       "vmovupd 360448(%%rdx), %%zmm29\n\t"
                       "vmovupd 376832(%%rdx), %%zmm30\n\t"
                       "vmovupd 393216(%%rdx), %%zmm31\n\t"
                       "pushq %%rdx\n\t"
                       "movq $0, %%r14\n\t"
                       "2:\n\t"
                       "addq $8, %%r14\n\t"
                       ...
                       "vmovupd %%zmm9, 32768(%%rdx)\n\t"
                       "vmovupd %%zmm10, 49152(%%rdx)\n\t"
                       "vmovupd %%zmm11, 65536(%%rdx)\n\t"
                       "vmovupd %%zmm12, 81920(%%rdx)\n\t"
                       "vmovupd %%zmm13, 98304(%%rdx)\n\t"
                       "vmovupd %%zmm14, 114688(%%rdx)\n\t"
                       "vmovupd %%zmm15, 131072(%%rdx)\n\t"
                       "vmovupd %%zmm16, 147456(%%rdx)\n\t"
                       "vmovupd %%zmm17, 163840(%%rdx)\n\t"
                       "vmovupd %%zmm18, 180224(%%rdx)\n\t"
                       "vmovupd %%zmm19, 196608(%%rdx)\n\t"
                       "vmovupd %%zmm20, 212992(%%rdx)\n\t"
                       "vmovupd %%zmm21, 229376(%%rdx)\n\t"
                       "vmovupd %%zmm22, 245760(%%rdx)\n\t"
                       "vmovupd %%zmm23, 262144(%%rdx)\n\t"
                       "vmovupd %%zmm24, 278528(%%rdx)\n\t"
                       "vmovupd %%zmm25, 294912(%%rdx)\n\t"
                       "vmovupd %%zmm26, 311296(%%rdx)\n\t"
                       "vmovupd %%zmm27, 327680(%%rdx)\n\t"
                       "vmovupd %%zmm28, 344064(%%rdx)\n\t"
                       "vmovupd %%zmm29, 360448(%%rdx)\n\t"
                       "vmovupd %%zmm30, 376832(%%rdx)\n\t"
                       "vmovupd %%zmm31, 393216(%%rdx)\n\t"
                       "addq $64, %%rdx\n\t"
                       "subq $131008, %%rdi\n\t"
                       "cmpq $128, %%r12\n\t"
                       "jl 1b\n\t"
