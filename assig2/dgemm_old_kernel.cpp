	...
	for (int n = 0; n < N; n+=8) {
		for (int m = 0; m < M; m +=8) {
			...
			for (int k = 0; k < K; k++) {
				...
				a_0k_1k_2k_3k_4k_5k_6k_7k_v = _mm512_load_pd( (double *) &A_tmp[k*M]);
						
				b_k0_v2 = _mm512_set1_pd(B_tmp[k]);
				b_k1_v2 = _mm512_set1_pd((B_tmp[1*K + k]));
				b_k2_v2 = _mm512_set1_pd((B_tmp[2*K + k]));
				b_k3_v2 = _mm512_set1_pd((B_tmp[3*K + k]));
				b_k4_v2 = _mm512_set1_pd((B_tmp[4*K + k]));
				b_k5_v2 = _mm512_set1_pd((B_tmp[5*K + k]));
				b_k6_v2 = _mm512_set1_pd((B_tmp[6*K + k]));
				b_k7_v2 = _mm512_set1_pd((B_tmp[7*K + k]));
			...
			_mm512_store_pd(&C_tmp[0*S], c_00_10_20_30_40_50_60_70_v);
			_mm512_store_pd(&C_tmp[1*S], c_01_11_21_31_41_51_61_71_v);
			_mm512_store_pd(&C_tmp[2*S], c_02_12_22_32_42_52_62_72_v);
			_mm512_store_pd(&C_tmp[3*S], c_03_13_23_33_43_53_63_73_v);
			_mm512_store_pd(&C_tmp[4*S], c_04_14_24_34_44_54_64_74_v);
			_mm512_store_pd(&C_tmp[5*S], c_05_15_25_35_45_55_65_75_v);
			_mm512_store_pd(&C_tmp[6*S], c_06_16_26_36_46_56_66_76_v);
			_mm512_store_pd(&C_tmp[7*S], c_07_17_27_37_47_57_67_77_v);
